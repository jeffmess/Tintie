...
$(function(){
  ...
  window.TaskCollection = Backbone.Collection.extend({
    ...
    url: '/tasks',
		...
		incomplete: function() {
      return this.filter(function(task){ return task.get('completed') === false; });
    },
    ...
    createTask: function(e) {
      ...
      var params = this.newAttributes(values);
		...
		filterToday: function() {
			window.Tasks.url = "/tasks/due_date?date=today";
			window.Tasks.fetch();
		},
		
		filterTomorrow: function() {
			window.Tasks.url = "/tasks/due_date?date=tomorrow";
			window.Tasks.fetch();
		},
		
		filterWeek: function() {
			window.Tasks.url = "/tasks/due_date?date=week";
			window.Tasks.fetch();
		},
		
		filterLater: function() {
			window.Tasks.url = "/tasks/due_date?date=later";
			window.Tasks.fetch();
		},
		
		filterWithoutDate: function() {
			window.Tasks.url = "/tasks/due_date?date=without_date";
			window.Tasks.fetch();
		},
		
		filterOverdue: function() {
			window.Tasks.url = "/tasks/due_date?date=overdue";
			window.Tasks.fetch();
		},
